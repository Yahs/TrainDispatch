...
public class Driver2 {
	...
	public static void main(String[] args) {
		...
		connections.add(map.callStation(0).getEdge(map.callStation(1), 5));
		connections.add(map.callStation(38).getEdge(map.callStation(36), 6));
		...
		connections.add(map.callStation(30).getEdge(map.callStation(31), 10));
		...
		connections.add(map.callStation(26).getEdge(map.callStation(35), 15));
		...
		connections.add(map.callStation(35).getEdge(map.callStation(37), 18));
		...
		connections.add(map.callStation(19).getEdge(map.callStation(38), 23));
		...
		connections.add(map.callStation(17).getEdge(map.callStation(32), 28));
		...
		connections.add(map.callStation(32).getEdge(map.callStation(34), 31));
		...
		connections.add(map.callStation(36).getEdge(map.callStation(39), 38));
		connections.add(map.callStation(31).getEdge(map.callStation(33), 39));
		connections.add(map.callStation(20).getEdge(map.callStation(21), 40));
		connections.add(map.callStation(34).getEdge(map.callStation(33), 41));
		connections.add(map.callStation(33).getEdge(map.callStation(39), 42));
		connections.add(map.callStation(33).getEdge(map.callStation(37), 43));
